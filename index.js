...
//By using implicit global variable behaviour. 
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    /*Your Code Here*/
    const newZooAnimalsData = data.map(function(item){
      return item.animal_name.toLowerCase();

    })
     return newZooAnimalsData;
  }
...
function greeting(firstName, lastName){
  ...
  console.log(consume('Amanuel', 'Gilay',greeting));
